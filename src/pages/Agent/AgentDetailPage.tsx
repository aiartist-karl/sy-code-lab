  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#0F172A] overflow-y-auto">
      <div className="flex items-center px-4 py-3 border-b border-slate-200 dark:border-slate-700">
        ...
        <h1 className="ml-2 text-base font-semibold text-slate-800 dark:text-slate-100">Agent Details</h1>
      </div>
      ...
      <div className="flex flex-col items-center px-6 pt-8 pb-6">
        ...
        <div className="flex items-center gap-6 mt-6">
          <div className="text-center"><p className="text-lg font-bold text-slate-800 dark:text-slate-100">{agent.conversationCount.toLocaleString()}</p><p className="text-xs text-slate-500 dark:text-slate-400">Conversations</p></div>
          <div className="w-px h-8 bg-slate-200 dark:bg-slate-700"></div>
          <div className="text-center"><p className="text-lg font-bold text-slate-800 dark:text-slate-100">4.8</p><p className="text-xs text-slate-500 dark:text-slate-400">Rating</p></div>
          <div className="w-px h-8 bg-slate-200 dark:bg-slate-700"></div>
          <div className="text-center"><p className="text-lg font-bold text-slate-800 dark:text-slate-100">Free</p><p className="text-xs text-slate-500 dark:text-slate-400">Pricing</p></div>
        </div>
      </div>
      ...
      <div className="px-6 mt-6 pb-6">
        <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-3">Created by</h3>
        <div className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
          <div className="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center">
            <span className="text-sm font-bold text-indigo-600 dark:text-indigo-400">CZ</span>
          </div>
          <div><p className="text-sm font-medium text-slate-800 dark:text-slate-100">SY Code Lab Official</p><p className="text-xs text-slate-500 dark:text-slate-400">Verified Creator</p></div>
        </div>
      </div>
    </div>
  );
